...
class Registry:
    ...
    def update(
        ...
        *,
        ...
        nearai.log(target=f"Update in registry", id=id, **update)
    ...
    def add(
        ...
        *,
        ...
        nearai.log(target=f"Add to registry", name=name, author=author)
        return registry_id
    ...
    def upload(
        ...
        *,
        ...
        nearai.log(target=f"Upload to S3", path=s3_path, author=author)
