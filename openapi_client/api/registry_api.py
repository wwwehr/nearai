...
class RegistryApi:
    ...
    @validate_call
    def list_projects_v1_registry_list_projects_post(
        self,
        ...
        _param = self._list_projects_v1_registry_list_projects_post_serialize(
            category=category,
            tags=tags,
            total=total,
    ...
    @validate_call
    def list_projects_v1_registry_list_projects_post_with_http_info(
        self,
        category: Optional[StrictStr] = None,
        tags: Optional[StrictStr] = None,
        total: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ProjectLocation]]:
        """List Projects
    ...
    @validate_call
    def list_projects_v1_registry_list_projects_post_without_preload_content(
        self,
        category: Optional[StrictStr] = None,
        tags: Optional[StrictStr] = None,
        total: Optional[StrictInt] = None,
    ...
    def _list_projects_v1_registry_list_projects_post_serialize(
        self,
        category,
        tags,
        total,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/registry/list_projects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
