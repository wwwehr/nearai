...
from openapi_client.models.image_url_param import ImageURLParam
...
class ImageURLContentBlockParam(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImageURLContentBlockParam from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImageURLContentBlockParam from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "image_url": ImageURLParam.from_dict(obj["image_url"]) if obj.get("image_url") is not None else None,
            "type": obj.get("type")
        })
        return _obj
