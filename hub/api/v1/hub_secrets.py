...
async def get_user_secrets(
    ...
    """Get hub secret for a given user.
...
@hub_secrets_router.get("/vector_stores")
...
@hub_secrets_router.get("/vector_stores/{vector_store_id}")
...
@hub_secrets_router.patch("/vector_stores/{vector_store_id}")
...
@hub_secrets_router.delete("/vector_stores/{vector_store_id}")
...
@hub_secrets_router.post("/vector_stores/{vector_store_id}/files")
...
@hub_secrets_router.post("/vector_stores/{vector_store_id}/search")
...
@hub_secrets_router.post("/vector_stores/from_source", response_model=VectorStore)
